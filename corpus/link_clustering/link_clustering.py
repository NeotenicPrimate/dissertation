...
# Copyright 2008,2009,2010,2021 James Bagrow, Yong-Yeol Ahn
#
#
...
def write_edge2cid(e2c,filename,delimiter="\t"):
    ...
    for e,c in sorted(list(e2c.items()), key=itemgetter(1)):
...
"""
    ...
    if threshold is not None:
        ...
        if is_weighted:
            ...
            if dendro_flag:
                edge2cid,S_max,D_max,list_D, orig_cid2edge, linkage = HLC( adj,edges ).single_linkage(dendro_flag=dendro_flag )
